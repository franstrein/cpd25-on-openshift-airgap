...
* [ ] 3. Update the vars/globals.yml with your environment specific values
```
	---
...
<b> Note: </b> One more additional step, adjust the /etc/hosts file on all machines:
In Bastion node edit the hosts file with command
	vi /etc/hosts
and comment out default entries for local hosts. And replace with:
```
	...
	#127.0.0.1 cpd-workshop1.demo.ibmcloudpack.com cpd-workshop1
	#127.0.0.1 localhost.localdomain localhost
	#127.0.0.1 localhost4.localdomain4 localhost4

	# The following lines are desirable for IPv6 capable hosts
	#::1 cpd-workshop1.demo.ibmcloudpack.com cpd-workshop1
	#::1 localhost.localdomain localhost
	#::1 localhost6.localdomain6 localhost6
	# Entries for RHOS and CP$D Cluster
	127.0.0.1   localhost localhost.domain localhost4 localhost4.domain4
	::1         localhost localhost.domain localhost6 localhost6.domain6
	169.62.100.198 cpd-workshop1.demo.ibmcloudpack.com cpd-workshop1
	169.62.100.242 cpd-workshop1.master-01.demo.ibmcloudpack.com cpd-workshop1.master-01
	169.62.100.200 cpd-workshop1.worker-01.demo.ibmcloudpack.com cpd-workshop1.worker-01
	169.62.100.161 cpd-workshop1.worker-02.demo.ibmcloudpack.com cpd-workshop1.worker-02

	copy to all 3 machines:
	scp /etc/hosts 169.62.242:/etc/hosts
	Same for 2 other machines
``` 
